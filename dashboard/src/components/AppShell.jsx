 ...
 * AppShell.jsx
 * ─────────────────────────────────────────────────────────────────────────────
 * Root layout shell for the EBITDA Intelligence Platform.
 *
 * Structure:
 *   ┌──────────┬──────────────────────────────────────┐
 ...
 *   └──────────┴──────────────────────────────────────┘
 *
 * The sidebar contains the complete 10-screen nav. Screens 2–10 render a
 * "Coming Soon" stub until built in subsequent sessions.
 *
 * primary_colour is sourced from company config — never hardcoded.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
// ── Icon components (inline SVG, 16×16) ───────────────────────────────────
...
function IconProduction() {
  return <SvgIcon>
    <rect x="2" y="10" width="3" height="4" rx="0.5" fill="currentColor" opacity=".9"/>
    <rect x="6.5" y="7" width="3" height="7" rx="0.5" fill="currentColor" opacity=".7"/>
    <rect x="11" y="4" width="3" height="10" rx="0.5" fill="currentColor" opacity=".5"/>
  </SvgIcon>;
}
function IconSales() {
  return <SvgIcon>
    <path d="M2 12L6 7l3 3 5-7" stroke="currentColor" strokeWidth="1.5"
...
function IconDailyPlan() {
  return <SvgIcon>
    ...
    <path d="M5 2v2M11 2v2M2 7h12" stroke="currentColor" strokeWidth="1.5"
      strokeLinecap="round"/>
    <circle cx="6" cy="10" r="1" fill="currentColor"/>
    <circle cx="10" cy="10" r="1" fill="currentColor" opacity=".5"/>
  </SvgIcon>;
}
function IconWeeklyPlan() {
  return <SvgIcon>
    <rect x="2" y="3" width="12" height="11" rx="1.5" stroke="currentColor"
      strokeWidth="1.5" fill="none"/>
    <path d="M5 2v2M11 2v2M2 7h12" stroke="currentColor" strokeWidth="1.5"
      strokeLinecap="round"/>
    <path d="M5 10h6M5 12.5h4" stroke="currentColor" strokeWidth="1.2"
...
function IconModels() {
  return <SvgIcon>
    ...
    <path d="M6.5 7L9.5 4.8M6.5 9L9.5 11.2" stroke="currentColor" strokeWidth="1"
      opacity=".5"/>
  </SvgIcon>;
}
function IconSimulator() {
  return <SvgIcon>
    <path d="M2 14h12M4 14V9M8 14V5M12 14V2" stroke="currentColor"
      strokeWidth="1.5" strokeLinecap="round"/>
    <circle cx="8" cy="5" r="1.5" fill="currentColor"/>
    <circle cx="12" cy="2" r="1.5" fill="currentColor" opacity=".5"/>
  </SvgIcon>;
}
function IconStrategy() {
  return <SvgIcon>
    <path d="M2 8h2.5l2-5 3 10 2-7L13.5 8H14" stroke="currentColor"
...
function ComingSoonScreen({ item }) {
  return (
    <div style={{
      ...
      <div style={{ opacity: 0.3, transform: "scale(2.5)" }}>
        <item.icon />
      </div>
      <p style={{ fontSize: 15, fontWeight: 500, marginTop: 24 }}>
        {item.label}
      </p>
      <p style={{ fontSize: 13, color: "var(--color-text-tertiary)" }}>
        Session {item.phase + 5} — coming soon
        {item.phaseNote ? ` · ${item.phaseNote}` : ""}
      </p>
    </div>
  );
}
...
// ── AppShell ───────────────────────────────────────────────────────────────
export default function AppShell({ screens }) {
  ...
  return (
    <div style={{
      ...
      fontFamily: "'Syne', var(--font-sans), sans-serif",
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <p style={{
              fontSize: 11, color: "var(--color-text-tertiary)", margin: 0,
        ...
        <div style={{
          ...
          <div style={{
            ...
            {company.current_user.name.slice(0, 2).toUpperCase()}
          </div>
          <div style={{ minWidth: 0 }}>
            <p style={{
      ...
      <main style={{ flex: 1, overflowY: "auto", padding: "28px 32px" }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              fontSize: 12, color: "var(--color-text-tertiary)", margin: "2px 0 0",
              letterSpacing: "0.04em",
            }}>
              {activeItem?.audience}
            </p>
        ...
        {ActiveScreen ? (
          ...
          <ComingSoonScreen item={activeItem} />
        )}
      </main>
    </div>
  );
  ...
  return (
    <button
      ...
      style={{
        ...
        color: active ? primary : "var(--color-text-secondary)",
        marginBottom: 1,
    ...
    >
      ...
      {item.phaseNote && (
        <span style={{
          ...
          borderRadius: 4, background: "#FAEEDA", color: "#854F0B",
